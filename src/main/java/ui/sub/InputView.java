...
public class InputView extends JDialog
{
   ...
   private JLabel removeQuotesLabel = new JLabel("remove quotes");
   private JCheckBox removeQuotes = new JCheckBox();

   private JLabel removeSingleQuotesLabel = new JLabel("remove single quotes");
   private JCheckBox removeSingleQuotes = new JCheckBox();

   InputView(Frame owner, Consumer<WindowEvent> windowEventConsumer)
   {
      super(owner);
   ...
   private void initLayout()
   {
      ...
      root.add(removeQuotes);
      root.add(removeQuotesLabel, "wrap");
      root.add(removeSingleQuotes);
      root.add(removeSingleQuotesLabel, "wrap");
   ...
   JCheckBox getRemoveQuotes()
   {
      return removeQuotes;
   }

   JCheckBox getRemoveSingleQuotes()
   {
